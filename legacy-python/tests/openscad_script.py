...
def gen_samples(file_path=f"{os.path.dirname(os.path.realpath(__file__))}/samples.csv", openscad_path=None):
    ...
    with open(file_path, 'r') as f:
        ...
        for line in data:
            ...
            args = [
                openscad_path, '-o', filename, '-D', f'BRAND="{line[0]}"',
